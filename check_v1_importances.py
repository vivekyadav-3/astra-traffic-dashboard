...
def main():
    ...
    # Map features to day 48 training set
    ...
    print("Training ExtraTrees on Day 49 only...")
    ...
    imp = pd.Series(et_day49.feature_importances_, index=feature_cols).sort_values(ascending=False)
    print("\nET Day 49 Feature Importances:")
    print(imp)

    print("\nTraining ExtraTrees on Combined train...")
    ...
    imp_comb = pd.Series(et_comb.feature_importances_, index=feature_cols).sort_values(ascending=False)
    print("\nET Combined Feature Importances:")
    print(imp_comb)
